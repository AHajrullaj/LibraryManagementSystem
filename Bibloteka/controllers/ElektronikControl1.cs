...
{
    public partial class ElektronikControl1 : UserControl
    {
        singleBook frm;
        
        public ElektronikControl1()
        {
            InitializeComponent();
            
        }

        private void ElektronikControl1_Load(object sender, EventArgs e)
        {
            ...
            scn.Open();
            SqlDataAdapter sqlDa = new SqlDataAdapter("Select liber.Id ,emer,autor,ISBN,sasia,gjendje from Liber join liber_kategoriLiber on liber_kategoriLiber.Liber_Id=Liber.Id join KategoriLibri on liber_kategoriLiber.KategoriLibri_Id=KategoriLibri.id where KategoriLibri_Id=2 ", scn);
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sqlDa = new SqlDataAdapter("Select emer,autor,ISBN,sasia,gjendje from Liber join liber_kategoriLiber on liber_kategoriLiber.Liber_Id=Liber.Id join KategoriLibri on liber_kategoriLiber.KategoriLibri_Id=KategoriLibri.id where KategoriLibri_Id=2 and (emer like '%" + textBox1.Text + "%' or autor like '%" + textBox1.Text + "%')", scn);
            DataTable dtbl = new DataTable();
            sqlDa.Fill(dtbl);
            dataGridView1.DataSource = dtbl;
        }
