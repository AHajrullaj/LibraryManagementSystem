...
{
    public partial class KimiControl1 : UserControl
    {
        singleBook frm;
        public KimiControl1()
        {
        ...
        private void KimiControl1_Load(object sender, EventArgs e)
        {
            ...
            scn.Open();
            SqlDataAdapter sqlDa = new SqlDataAdapter("Select Liber.Id,emer,autor,ISBN,sasia,gjendje from Liber join liber_kategoriLiber on liber_kategoriLiber.Liber_Id=Liber.Id join KategoriLibri on liber_kategoriLiber.KategoriLibri_Id=KategoriLibri.id where KategoriLibri_Id=4 ", scn);
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sqlDa = new SqlDataAdapter("Select emer,autor,ISBN,sasia,gjendje from Liber join liber_kategoriLiber on liber_kategoriLiber.Liber_Id=Liber.Id join KategoriLibri on liber_kategoriLiber.KategoriLibri_Id=KategoriLibri.id where KategoriLibri_Id=4 and (emer like '%" + textBox1.Text + "%' or autor like '%" + textBox1.Text + "%')", scn);
            DataTable dtbl = new DataTable();
            sqlDa.Fill(dtbl);
            dataGridView1.DataSource = dtbl;
        }
